...
public sealed class DashboardController : ControllerBase
{
	...
	/// </summary>
	/// <param name="startDate">Data inicial opcional para filtro de eventos (formato: yyyy-MM-dd ou yyyy-MM-ddTHH:mm:ss).</param>
	/// <param name="endDate">Data final opcional para filtro de eventos (formato: yyyy-MM-dd ou yyyy-MM-ddTHH:mm:ss).</param>
